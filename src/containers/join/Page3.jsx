    ...
    return (
        <div className="home-page page3">
            <div className="home-page-wrapper">
                ...
                <h2>Testimonials</h2>
                <OverPack>
                    <QueueAnim key="queue" type="bottom"  className="page2-content">
                        <p key="a" className="page-content">
                            Better workout than Barry's. -Aaron Lu
                        </p>

                        <p key="b" className="page-content">
                        ...
                        <p key="c" className="page-content">
                        ...
                        <p key="d" className="page-content">

...
const featuresCN = [
    {
        title: 'Re-engage with your coworkers',
        content: 'Quarantine can be lonely, come see your workers!',
    ...
    {
        title: 'Get Shredded',
        content: 'Look good and feel good when talking to clients!',
    ...
    {
        title: 'Disconnect',
        content: 'Take a break and get away from your computer!',
                ...
                <li key={i.toString()} >
                    ...
                    >
                        <TweenOneGroup
                            ...
                            enter={this.getEnter}
                            leave={{
                                x: 0, y: 320, opacity: 0, duration: 300, ease: 'easeInBack',
                            }}
        ...
        return (
            <div className="home-page page1" >
                <div className="home-page-wrapper" id="page1-wrapper">
                    ...
                    <h2>What can <span>5 minutes</span> do for you </h2>
